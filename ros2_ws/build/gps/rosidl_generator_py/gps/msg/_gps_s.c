...
bool gps__msg__gps__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gps.msg._gps.GPS", full_classname_dest, 16) == 0);
  }
  gps__msg__GPS * ros_message = _ros_message;
  {  // lat
...
PyObject * gps__msg__gps__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gps.msg._gps");
